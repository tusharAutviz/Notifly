...
Revision ID: 728bd4239b60
Revises: 4a0812ab8b1a
Create Date: 2025-04-30 12:44:30.433178
...
revision = '728bd4239b60'
down_revision = '4a0812ab8b1a'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.drop_index('ix_school_id', table_name='school')
...
def downgrade() -> None:
    ...
    sa.Column('phone_no', sa.VARCHAR(), nullable=True),
    ...
    op.create_index('ix_school_id', 'school', ['id'], unique=False)
