...
Revision ID: 492889296658
Revises: 6360ad27beaf
Create Date: 2025-04-28 11:54:25.308631
...
revision = '492889296658'
down_revision = '6360ad27beaf'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index('ix_contacts_student_name', 'contacts', ['parent_name'], unique=False)
